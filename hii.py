#!/usr/bin/env python3
"""
Render-deployable FREE VIDEO BOT  (requests + html.parser only)
No lxml, no compile errors
"""
...
def main():
    ...
    # bot polling in thread so Flask keeps listening
    import threading
    threading.Thread(target=app.run_polling, daemon=True).start()
    # Render gives PORT env var
